			...
			foreach($this->imports as $ns => $list) {
				foreach ($list as $ii) {
					if ($ii['location'] != '') {
						...
						if ($ii['schemaLocation'] != '') {
							$xml .= " <$schemaPrefix:import schemaLocation=\"" . $ii['schemaLocation'] . '" namespace="' . $ns . "\" />\n";
						} else {
...
class soap_transport_http extends nusoap_base {
	...
	* @access   private
	*/
	function connect($connection_timeout=0,$response_timeout=3600){
...
//		}
	...
	* @access   public
	*/
	function send($data, $timeout=0, $response_timeout=3600, $cookies=NULL) {
	...
	* @deprecated
	*/
	function sendHTTPS($data, $timeout=0, $response_timeout=3600, $cookies) {
...
class wsdl extends nusoap_base {
     ...
     * @access public
     */
    function wsdl($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=0,$response_timeout=3600,$curl_options=null,$use_curl=false){
		parent::nusoap_base();
...
class nusoap_client extends nusoap_base  {
	...
	* @access   private
	*/
	function send($msg, $soapaction = '', $timeout=0, $response_timeout=3600) {
		$this->checkCookies();
		// detect transport
		switch(true){
			// http(s)
